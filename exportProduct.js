  ...
  try {
    ...
    while (true) {
      ...
      const filteredProducts = products.map((product) => ({
        ...
        variantKey: product.masterVariant.sku,
        name: product.name,
      }));
      ...
      fs.appendFileSync(outputPath, JSON.stringify(filteredProducts, null, 2).slice(1, -1));
    ...
    console.log('Filtered product projections have been saved to productProjections.json');
  } catch (error) {
